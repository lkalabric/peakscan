...
This is an effort to parse microsatellite trace files in fsa format together with epidemiological data to create data that can be uploaded at Online Program SpadeR https://chao.shinyapps.io/SpadeR/.
...
fsa_data <- storing.inds(fsa_dir, channels=5)
```
